...
(function ($) {
    ...
    function _11(_12) {
        ...
        _15.find("div.tree-node").draggable({
            ...
            accept: "div.tree-node", onDragEnter: function (e, _1a) {
                ...
                _1c(_1d, true);
                $(this).removeClass("tree-node-append tree-node-top tree-node-bottom");
                //re:添加dragPoint属性,可指定拖拽点事件
                if (_1e > top + (_1f - top) / 2) {
                    if (_1f - _1e < 5) {
                        $(this).addClass("tree-node-" + _13.options.dragPoint[3]);
                    } else {
                        $(this).addClass("tree-node-" + _13.options.dragPoint[2]);
                    }
                } else {
                    if (_1e - top < 5) {
                        $(this).addClass("tree-node-" + _13.options.dragPoint[0]);
                    } else {
                        $(this).addClass("tree-node-" + _13.options.dragPoint[1]);
                    }
                }
    ...
    function _6f(_70, ul, _71, _72) {
        ...
        var _77 = _73.loader.call(_70, _71, function (_78) {
            ...
            //re:自定义dataFormat事件 格式化服务器数据
            _73.dataFormat.call(_70, _78);
    ...
    $.fn.tree.defaults = {
        url: null, method: "post", animate: false, checkbox: false, cascadeCheck: true, onlyLeafCheck: false, dragPoint: ["top", "append", "append", "bottom"], lines: false, dnd: false, data: null, queryParams: {}, formatter: function (node) {
            return node.text;
